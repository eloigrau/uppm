    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut_adhesion', models.IntegerField(choices=[('', '-----------'), (0, 'Je souhaite devenir membre du collectif ACVI et utiliser le site'), (1, "Je suis membre d'un autre collectif du pacte pour la transition"), (2, 'Je suis membre du collectif ACVI')], default='0')),
