# -*- coding: utf-8 -*-
"""
Django settings for Pacte project.
...
MIDDLEWARE = [
   ...
   # 'pacte.middleware.SetLastVisitMiddleware'
    #'django.core.context_processors.request',
    #'debug_toolbar.middleware.DebugToolbarMiddleware',
]


ROOT_URLCONF = 'pacte.urls'
...
WSGI_APPLICATION = 'pacte.wsgi.application'
# Database
if LOCALL:
    DATABASES = {
       'default': {
